...
## Project Structure
    ...
    ├── your_daily_reading_28789  # Django project configurations
...
1. Clone this repo and `cd your_daily_reading_28789`
...
2. Clone this repo and `cd your_daily_reading_28789`
